...
$(document).ready(function(){
  /*---------- Image swap code start ----------*/
   ...
   document.addEventListener('Specification', () => {
    ...
    addRowButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            setTimeout(() => {
                const newRow = document.querySelector('.dynamic-inline:last-child');
                if (newRow) {
                    console.log("New row found:", newRow);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  headers.forEach(header => {
      header.style.color = 'red'; // Change header text color to red
  });
});
